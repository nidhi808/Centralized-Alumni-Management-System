...
export default function StudentChat() {
  ...
  return (
    <DashboardLayout role="student">
      <div className="mb-6">
        <h2 className="text-2xl font-extrabold text-gray-900 dark:text-white">Mentorship Chat</h2>
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
          Real-time messaging with your accepted alumni mentors.
        </p>
      </div>
        ...
        <div className="w-80 border-r border-gray-100 dark:border-gray-700 flex flex-col shrink-0">
          <div className="px-5 py-4 border-b border-gray-100 dark:border-gray-700">
            <h3 className="text-sm font-bold text-gray-900 dark:text-white flex items-center gap-2">
              <FaComments className="text-[#086490]" /> Mentors
            </h3>
          </div>
          <div className="flex-1 overflow-y-auto">
            {connections.length === 0 ? (
              <div className="p-6 text-center text-gray-400 text-sm">
                ...
                <p className="text-xs mt-1">Request mentorship from the directory.</p>
              </div>
            ) : (
              connections.map((conn) => (
                ...
                >
                  <div className="relative">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#086490] to-blue-400 flex items-center justify-center text-white font-bold text-sm">
          ...
          {!selectedChat ? (
            ...
            <>
              ...
              <div className="px-6 py-4 border-b border-gray-100 dark:border-gray-700 flex items-center gap-3 bg-gray-50 dark:bg-gray-900/50">
                <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[#086490] to-blue-400 flex items-center justify-center text-white font-bold text-sm">
                  ...
                  return (
                    <div key={msg.id} className={`flex ${isMine ? 'justify-end' : 'justify-start'}`}>
                      <div className={`max-w-[70%] px-4 py-2.5 rounded-2xl text-sm ${
                        isMine
                          ? 'bg-[#086490] text-white rounded-br-md shadow-sm'
              ...
              <form onSubmit={handleSend} className="px-6 py-4 border-t border-gray-100 dark:border-gray-700 flex items-center gap-3 bg-white dark:bg-gray-800">
                <input
                  ...
                  placeholder="Ask for guidance or advice..."
